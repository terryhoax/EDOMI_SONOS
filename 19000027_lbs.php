...
[v#16		= 0	] //Treble
[v#17		= 0	] //Crossfade
[v#18		= 0	] //Radio �ber Namen
[v#19		= 0	] //MP3 abspielen
[v#20		= 0	] //Vergleicher AlbumArt Playliste
[v#21		= 0	] //Vergleicher Radiosender
[v#22		= 0 ] //Lautst�rke um Faktor E#22 erh�hen
[v#23		= 0 ] //Lautst�rke um Faktor E#22 veringern
[v#24		= 0 ] //Faktor f�r die Lautst�rkever�nderung
...
###[HELP]###
Die Datei sonosAccess.php wird ben�tigt. Datei ist im Download dabei.
...
E1: Signal 1 = Startet Baustein (D�mon)
E2: KO f�r iP Adesse vom Sonos Ger�t
E3: KO f�r Play (wird bei 1 ausgel�st, Pause bei 0)
E4: KO f�r Stop (wird bei 1 ausgel�st)
E5: KO f�r Pause (wird bei 1 ausgel�st)
E6: KO f�r Volume (0 bis 50)
E7: KO f�r Playmode (0= "NORMAL", 1= "REPEAT_ALL", 2= "REPEAT_ONE", 3= "SHUFFLE_NOREPEAT", 4= "SHUFFLE", 5= "SHUFFLE_REPEAT_ONE")
E8: KO f�r Mute (0=Off / 1=On)
E9: KO f�r Wahl Radiosender  (String per KO �bergeben! == z.B. "x-sonosapi-stream:s68934?sid=254&flags=8224&sn=0")
E10: KO f�r Playlist (String per KO �bergeben! == z.B. "x-rincon-queue:RINCON_B8E9378E827A01400#0")
E11: KO f�r Next (wird bei 1 ausgel�st)
E12: KO f�r Previous (wird bei 1 ausgel�st)
E13: KO f�r Rewind (wird bei 1 ausgel�st)
E14: KO f�r Loudness (0= Off / 1=On)
E15: KO f�r Bass (-10 bis 10)
E16: KO f�r Treble (-10 bis 10)
E17: KO f�r Crossfade (0= Off / 1=On)
E18: KO f�r Radisender �ber Namen die in der sonos.Access.php gespeichert sind. (z.B als KO "Bayern 3")
E19: KO f�r MP3 file (kann als "http://www.sounds.com/blubb.mp3" oder �ber einen Share "//mp3/sonos/bla.mp3" �bergeben werden)
E20: KO f�r MP3 Lautst�rke (Hier kann die Lautst�rke f�r das Abspielen vom MP3 File �bergeben werde)
E21: Logging aktivieren/deaktivieren
E22: Lautst�rke um den Wert aus E24 erh�hen (wird bei 1 ausgel�st)
E23: Lautst�rke um den Wert aus E24 veringern (wird bei 1 ausgel�st)
E24: Faktor f�r die Lautst�rkeanpassung (Standard=1)
...
A5: Artist
A6: Album
A7: url für Cover (Bei Radiosendern nur wenn der Sender �ber E18 �bergeben wird)
A8: Duration
A9: RelTime
A10: leer
...
A17: CurrentURI Einfach an der Sonos App Radiosender oder Playliste auswählen. (dieser URI kann als Playliste oder Radiosender in ein KO kopiert werden und dann an E9 oder E10 �bergeben werden.  Wird nur im Debug ausgegeben!)

Changelog:
==========
v1.5: Initial version	
v2.0: Performance und Code Anpassung
v2.2: Send by change bei den Ausg�ngen
v2.5: Send by change bei den A1 Ausgang angepasst
v2.6: Lautst�rke up/down hinzugef�gt
...
function LB_LBSID($id) {
	if ($E=getLogicEingangDataAll($id)) {
		...
		if ($E[18]['refresh']==1){ //Radio über Namen
...
$transportInfo=$sonos->GetTransportInfo();
		...
		if ($V[18]==1) { //Radio über Namen abspielen
		...
		if ($V[22]==1) {//Volume up
			...
			//usleep(500);
			//$volume=$sonos-> GetVolume();
			//damit keine Verz�gerung beim mehrfachen Erh�hen der LS entsteht, wird der berechnete Weert auf den Ausgang geschrieben.
